...
import { Home, Camera, BookOpen, Heart } from 'lucide-react'
...
export function TabBar() {
  ...
  return (
    <nav
      ...
      style={{ background: 'rgba(10,10,10,0.92)', backdropFilter: 'blur(20px)', WebkitBackdropFilter: 'blur(20px)', borderTop: '0.5px solid #2C2C2E' }}
    >
      <div
